...
const SECTION_MAP = {
  ...
  header_4:dynamic(() => import("@/components/sections/AnirbanHeaderSalon")),
  hero_1: dynamic(() => import("@/components/sections/Hero1")),
  hero_2: dynamic(() => import("@/components/sections/Hero2")),
  hero_3: dynamic(() => import("@/components/sections/AnirbanHeroSalon")),
  about_1: dynamic(() => import("@/components/sections/About1")),
  about_2: dynamic(() => import("@/components/sections/AnirbanAboutUs")),
  services_1: dynamic(() => import("@/components/sections/Services1")),
  services_2: dynamic(() => import("@/components/sections/AnirbanServices")),
  testimonial_1: dynamic(() => import("@/components/sections/Testimonial1")),
  testimonial_2: dynamic(() => import("@/components/sections/AnirbanTestimonials")),
  shopnow_1: dynamic(() => import("@/components/sections/AnirbanShopnow")),
  faq_1: dynamic(() => import("@/components/sections/FAQ1")),
  contact_1: dynamic(() => import("@/components/sections/Contact1")),
  contact_2: dynamic(() => import("@/components/sections/AnirbanSinhaContact")),
  footer_1: dynamic(() => import("@/components/sections/Footer1")),
  footer_2: dynamic(() => import("@/components/sections/AnirbanFooter")),
  banner_1: dynamic(() => import("@/components/sections/AnirbanBanner")),
  gallery_1: dynamic(() => import("@/components/sections/Gallery1")),
  gallery_2: dynamic(() => import("@/components/sections/Gallery2")),
  gallery_3: dynamic(() => import("@/components/sections/AnirbanGallery")),
